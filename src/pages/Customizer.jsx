...
const Customizer = ({ mouseMovement, handleMouseMove }) => {
    ...
    const handleSubmit = async (type) => {
        ...
        try {
            ...
            const response = await fetch(`${import.meta.env.VITE_BACKEND_URL}/api/v1/sdapi`, {
                method: 'POST',
                headers: {
    ...
    const handleFeedbackClick = () => {
        window.location.href = "mailto:bhoiratharva211@gmail.com?subject=Feedback&body=Hi%20there,%0A%0AHere's%20my%20feedback...";
    };
